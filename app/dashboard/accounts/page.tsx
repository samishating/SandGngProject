...
export default async function AccountFinderPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  // Every customer, not just this agent's. Whoever picks up the phone needs
  // the caller's history, whether or not they were the one who sold to them.
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
      <div className="account-search-hero">
        ...
        <p className="card-body">
          Search any customer by name, phone number, email address or the order code they read out.
        </p>
